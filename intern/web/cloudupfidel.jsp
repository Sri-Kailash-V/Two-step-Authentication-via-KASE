...
<html>
    ...
    <div style="margin-left: 10%;padding: 3% 4%;background-color: rgba(225,225,225,.5);border-radius: 70px">
        ...
        <table class="tts">
            <tr><th>File name</th><th>Uploaded on</th><th>Size</th></tr>
                    <% try {
                            MyCon x = new MyCon();
                            Connection c = x.tcon();
                            PreparedStatement st = c.prepareStatement("Select filename,date,size from aufiles ;");
